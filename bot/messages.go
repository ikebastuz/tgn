...
const (
	...
	MESSAGE_SELECT_SALARY_LOWER_BOUND    = "Your role is: %s\nSelect your lower salary bounds"
	...
	MESSAGE_USE_VALID_UPPER_BOUND        = "Upper bound should be less or equal then %d x lower bounds"
